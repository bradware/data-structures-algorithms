...
public class SimpleClass {
    ...
    /**
     * This method just checks if two int's are the same. This method is just for reference, you
     * do not need to add anything to this. We have this for the sample JUnit
     * test cases we have provided for you.
     * @param a
     * @param b
     ...
     *
     *Example : helloThing(1) Autoboxing allows a primitive type here
